  ...
  <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
    <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
      <div class="overflow-hidden">
        <h1 class="text-gray-500 font-bold mt-6 mb-6">{{$name}}</h1>
        <table class=" text-left text-sm font-light table-auto">
          ...
          <tbody>
            ...
            <tr class="border-b dark:border-neutral-500">
              <td class="whitespace-nowrap px-6 py-4 text-gray-500 font-medium align-text-top">{{ $lesson['start_at']->date }}</td>
